...
export default function Page() {
  ...
  const fetchActivity = async () => {
    try {
      const response = await fetch(
        `https://api.dev.vacaba.id/api/v1/destinations?page=1&limit=5&day=1`,
        {
          method: "GET",
          headers: {
      ...
      //   console.log("Data aktivitas:", data.data);
  ...
  return (
    // <div>
    <Layout>
      <div className="header mt-6 ml-6">
        <h2 className='text-4xl font-bold dark:text-white font-["Poppins"]'>
          Mau Kemana?
        </h2>
